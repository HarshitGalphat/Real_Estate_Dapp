...
contract RealEstate is ContractMetadata{
    ...
    function updatePrice(address owner,uint256 productId,uint256 price)external returns(string memory){
        ...
        require(property.owner == owner ,"Your are not owner");
   ...
   function buyProperty(uint256 id,address buyer) external payable{
    ...
    function getProperty(uint256 id) external view returns(uint256,address,uint256,string memory,string memory,string memory,string memory,string memory,address[] memory,string[] memory){
